...
function withParams(urlString) {
    try {
        ...
        if (!u.searchParams.has('connection_timeout')) u.searchParams.set('connection_timeout', '10000');
        return u.toString();
    } catch {
        return urlString;
    }
...
export async function connect() {
    ...
    if (connecting) {
        // brief wait for ongoing connect
    ...
    try {
        ...
        retryDelayMs = 2000; // reset backoff on success
